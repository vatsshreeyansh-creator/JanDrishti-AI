                ...
                <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-mono text-[#9ab0a2] flex items-center gap-1">
                      <MapPin className="w-3 h-3 text-[#5da673]" /> {report.location_name || 'Jharkhand'}
                    </span>
                  </div>
                ...
                <div className="mt-4 pt-3 border-t border-[#27342c] flex flex-wrap items-center justify-between gap-3">
                  <div className="flex items-center gap-3 text-xs font-mono text-[#9ab0a2]">
                    <span className="flex items-center gap-1">
                      <Clock className="w-3.5 h-3.5 text-[#5da673]" /> Sovereign Verified Intake
                    </span>
                    <span>•</span>
      ...
      <div className="bg-[#151d19] border border-[#27342c] p-6 rounded-2xl shadow-xl flex flex-col sm:flex-row items-start gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-[#9ab0a2] mt-1 leading-relaxed">
            Unlike legacy complaint boxes that bury grievances in bureaucratic queues, JanDrishti mathematically aggregates individual reports into GIS Hotspots. When multiple neighbors endorse or report a corridor, the algorithm elevates its Capex Priority Index, unlocking state infrastructure funds directly for local district nodal engineers.
          </p>
        </div>
      </div>
